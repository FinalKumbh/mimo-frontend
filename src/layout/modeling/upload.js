    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                <div>
                    <input type="file" className="uploadbutton" onChange={this.handleChange} />
                </div>  
                <div className="row">
                    <div className="col-6">
                        <div>
                        ...
                        <button type="button" className="btn btn-outline-light getstarted" onClick={this.onClickHandler.bind(this, 'options')}>
                            Upload
                        </button> 
                    </div>
                    <div className="col-6">
    ...
    render(){
        return(
            <div className='selection'>
                ...
                <button type="button" className="btn btn-outline-light apply" onClick={this.onApplyHandler}>
                    Apply
                </button>
            </div>
        );
