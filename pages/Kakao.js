import { info, log, warn } from "better-console";
...
const router = Router();
const kakao = {
  clientID: "35f4bc390062b853d32258198537f519",
  clientSecret: "GemFVXDQ7k1DW5NMI27O2RMF4hgVsa83 ",
...
function unlinkUser(session, provider, userId) {
  ...
  if (session.authData && session.authData[provider] && session.authData[provider].id === userId) {
